$ftp = "ftp://ftp.adobe.com//pub/adobe/acrobat/win/AcrobatDC"
...
If (!(Test-Path -Path $Source)) {
    ...
    $EXEDownload = "ftp://ftp.adobe.com//pub/adobe/acrobat/win/AcrobatDC/2001320064/AcrobatDCUpd2001320064.msp"
